...
- You cannot offer a version of Aerobridge that third parties can access, if you want to do this, you will need an agreement with Openskies (the license grant restriction)
- After 24 months, the code becomes Apache-2.0 licensed (the conversion period)

In other words, if you want to host / run Aerobridge inside your company, you are free to do so without any concerns or restrictions. If you want third parties to access data using a release of Aerobridge the opensource project that is less than two years old, you will need an agreement from Openskies.

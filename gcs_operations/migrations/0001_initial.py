    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_json', models.TextField(default='{"type":"FeatureCollection","features":[]}', help_text='Paste flight plan geometry as GeoJSON')),
                ('start_datetime', models.DateTimeField(default=datetime.datetime.now, help_text='Specify Flight start date and time in Indian Standard Time (IST)')),
                ('end_datetime', models.DateTimeField(default=datetime.datetime.now, help_text='Specify Flight end date and time in Indian Standard Time (IST)')),

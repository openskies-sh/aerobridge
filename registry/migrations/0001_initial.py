    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('master_components', models.ManyToManyField(to='registry.AircraftMasterComponent')),
            ],
        ),
        migrations.CreateModel(
            name='Authorization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('aircraft_model', models.ForeignKey(blank=True, db_constraint=False, help_text='Set the aircraft model associated with this component', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.aircraftmodel')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='aircraft_model',
            field=models.ForeignKey(help_text='Set the aircraft model associated with this component', on_delete=django.db.models.deletion.CASCADE, to='registry.aircraftmodel'),
        ),
        migrations.AddField(
            model_name='aircraftcomponent',

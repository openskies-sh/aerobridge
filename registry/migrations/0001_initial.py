    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('final_assembly', models.ForeignKey(blank=True, db_constraint=False, help_text='Assign a aircraft assembly to this aircraft', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.aircraftassembly')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='aircraft',
            name='final_assembly',
            field=models.OneToOneField(help_text='Assign a aircraft assembly to this aircraft', on_delete=django.db.models.deletion.CASCADE, to='registry.aircraftassembly'),
        ),
        migrations.AddField(
            model_name='aircraft',
            name='manufacturer',

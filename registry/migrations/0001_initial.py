    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master_component', models.ForeignKey(help_text='If no supplier exists, use the master component', null=True, on_delete=django.db.models.deletion.CASCADE, to='registry.aircraftmastercomponent', verbose_name='Master Component')),

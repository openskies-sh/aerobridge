    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='Internal part description', max_length=140, null=True, verbose_name='Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master_component_assembly', models.ForeignKey(blank=True, db_constraint=False, help_text='If no supplier exists, use the master component', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.mastercomponentassembly', verbose_name='Master Component Assembly')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='If no supplier exists, use the master component', null=True, on_delete=django.db.models.deletion.CASCADE, to='registry.aircraftmastercomponent', verbose_name='Master Component'),
        ),
        migrations.AddField(
            model_name='aircraftcomponent',
            name='master_component_assembly',
            field=models.ForeignKey(help_text='If no supplier exists, use the master component', null=True, on_delete=django.db.models.deletion.CASCADE, to='registry.mastercomponentassembly', verbose_name='Master Component Assembly'),
        ),
        migrations.AddField(
            model_name='aircraftcomponent',
            name='supplier_part',
            field=models.ForeignKey(blank=True, help_text='Select a matching supplier part for this stock item, if no supplier part is set you must set a Master Component', null=True, on_delete=django.db.models.deletion.SET_NULL, to='registry.supplierpart', verbose_name='Supplier Part'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='aircraftcomponent',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('master_component__isnull', True), ('master_component_assembly__isnull', True)), models.Q(('master_component__isnull', True), ('master_component_assembly__isnull', False)), models.Q(('master_component__isnull', False), ('master_component_assembly__isnull', True)), _connector='OR'), name='registry_aircraftcomponent_master_component_or_assembly'),
        ),
    ]

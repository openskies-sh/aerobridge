...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('status', models.IntegerField(choices=[(0, 'In Progress'), (1, 'Parts needed'), (2, 'Complete')], default=1, help_text='Set the status of this drone assembly, if it is set as inactive, the GCS might fail and flight plans might not be able to load on the drone')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series', models.CharField(default='2022.1', help_text='Define the production series for this Aircraft Model', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('final_assembly', models.ForeignKey(blank=True, db_constraint=False, help_text='Assign a aircraft assembly to this aircraft, if you do not see a assembly, it means that you will need to create a new assembly first.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.aircraftassembly')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='aircraft',
            name='final_assembly',
            field=models.OneToOneField(help_text='Assign a aircraft assembly to this aircraft, if you do not see a assembly, it means that you will need to create a new assembly first.', on_delete=django.db.models.deletion.CASCADE, to='registry.aircraftassembly'),
        ),
        migrations.AddField(
            model_name='aircraft',
            name='manufacturer',

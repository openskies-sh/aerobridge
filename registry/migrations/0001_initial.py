# Generated by Django 3.2.8 on 2021-10-10 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('power', models.DecimalField(decimal_places=2, default=0.0, help_text='Specify the engine power', max_digits=10)),
                ('count', models.IntegerField(default=1, help_text='Set the number of engines normally present')),
                ('engine_type', models.CharField(help_text='Specify the type of engine', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_number', models.CharField(blank=True, default='CO-TMP', help_text='Company number if avaiable', max_length=25, null=True, validators=[django.core.validators.RegexValidator(message='No special characters allowed in this field.', regex='^[-, ,_\\w]*$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_document', models.URLField(blank=True, default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', null=True, validators=[registry.models.validate_url])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_small', models.URLField(blank=True, help_text='A URL to link to a photo (small) of the pilot', null=True, validators=[registry.models.validate_url])),
                ('identification_photo', models.URLField(default='https://github.com/openskies-sh/aerobridge/blob/master/sample-data/id-card-sample.jpeg', validators=[registry.models.validate_url])),
                ('identification_photo_small', models.URLField(default='https://github.com/openskies-sh/aerobridge/blob/master/sample-data/id-card-sample.jpeg', validators=[registry.models.validate_url])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('person', models.OneToOneField(help_text='Assign this pilot to a person object', on_delete=django.db.models.deletion.CASCADE, to='registry.person')),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cin_document', models.URLField(default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to certificate of Incorporation issued by ROC, MCA')),
                ('gst_document', models.URLField(default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to GST certification document', validators=[registry.models.validate_url])),
                ('pan_card_document', models.URLField(default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='URL of Manufacturers PAN Card scan', validators=[registry.models.validate_url])),
                ('security_clearance_document', models.URLField(default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to Security Clearance from Ministry of Home Affairs', validators=[registry.models.validate_url])),
                ('eta_document', models.URLField(default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to Equipment Type Approval (ETA) from WPC Wing', validators=[registry.models.validate_url])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('make', models.CharField(blank=True, help_text='Enter aircraft make ', max_length=280, null=True)),
                ('master_series', models.CharField(blank=True, help_text='Specify the master series, if available', max_length=280, null=True)),
                ('series', models.CharField(blank=True, help_text='Enter aircraft production series, if available', max_length=280, null=True)),
                ('popular_name', models.CharField(blank=True, help_text='Enter popular name for this aircraft', max_length=280, null=True)),
                ...
                ('model', models.CharField(help_text='Set the model of the aircraft', max_length=280)),
                ...
                ('photo_small', models.URLField(default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='A URL of a small photo of the drone, used in the list page on the server')),
                ...
                ('identification_photo_small', models.URLField(blank=True, help_text='A cropped version of the', null=True)),
                ...
                ('manufactured_at', models.DateTimeField(blank=True, help_text='Set the date when the drone was manufactured', null=True)),
                ('dot_permission_document', models.URLField(blank=True, default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to Purchased RPA has ETA from WPC Wing, DoT for operating in the de-licensed frequency band(s). Such approval shall be valid for a particular make and model', null=True, validators=[registry.models.validate_url])),
                ('operations_manual_document', models.URLField(blank=True, default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to Operation Manual Document', null=True, validators=[registry.models.validate_url])),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('engine', models.ForeignKey(blank=True, db_constraint=False, help_text='Associate a engine with this aircraft', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.engine')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('manufacturer', models.ForeignKey(help_text='Associate a manufacturer to the firmware', on_delete=django.db.models.deletion.CASCADE, to='registry.manufacturer')),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dot_permission_document', models.URLField(blank=True, default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to Purchased RPA has ETA from WPC Wing, DoT for operating in the de-licensed frequency band(s). Such approval shall be valid for a particular make and model', null=True, validators=[registry.models.validate_url])),
                ('operations_manual_document', models.URLField(blank=True, default='https://raw.githubusercontent.com/openskies-sh/aerobridge/master/sample-data/Aerobridge-placeholder-document.pdf', help_text='Link to Operation Manual Document', null=True, validators=[registry.models.validate_url])),
                ('engine', models.ForeignKey(blank=True, help_text='Associate a engine with this aircraft', null=True, on_delete=django.db.models.deletion.CASCADE, to='registry.engine')),
                ('manufacturer', models.ForeignKey(help_text='Associate a manufacturer in the database to this aircraft', on_delete=django.db.models.deletion.CASCADE, to='registry.manufacturer')),
                ('operator', models.ForeignKey(help_text='Associate a operator to this Aircraft', on_delete=django.db.models.deletion.CASCADE, to='registry.operator')),

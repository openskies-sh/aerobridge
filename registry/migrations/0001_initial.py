    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('belongs_to', models.ForeignKey(blank=True, help_text='Is this item installed in another item?', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='installed_parts', to='registry.aircraftcomponent', verbose_name='Installed In')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('minimum_stock', models.PositiveIntegerField(default=0, help_text='Minimum allowed stock level', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Minimum Stock')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(help_text='Give this a name e.g. Aerobridge F1', max_length=280)),
                ('popular_name', models.CharField(help_text='e.g. F1', max_length=140)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('documents', models.ManyToManyField(help_text='Associate any existing documents to this series / model ', to='registry.aerobridgedocument')),
            ],
        ),
        migrations.CreateModel(
            name='Authorization',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(0, 'Supplier'), (1, 'Manufacturer'), (2, 'Operator'), (3, 'Customer')], default=3, help_text='Set the type of the company')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MPN', models.CharField(help_text='Manufacturer Part Number', max_length=100, null=True, verbose_name='MPN')),
                ('link', models.URLField(blank=True, help_text='URL for external manufacturer part link', null=True, validators=[common.validators.validate_url], verbose_name='Link')),
                ...
                ('manufacturer', models.ForeignKey(help_text='Select manufacturer', limit_choices_to={'is_manufacturer': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='manufactured_parts', to='registry.company', verbose_name='Manufacturer')),
                ('part', models.ForeignKey(help_text='Select part', limit_choices_to={'purchaseable': True}, on_delete=django.db.models.deletion.CASCADE, related_name='manufacturer_parts', to='registry.aircraftmastercomponent', verbose_name='Base Part')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(blank=True, help_text='URL for external supplier part link', null=True, validators=[common.validators.validate_url], verbose_name='Link')),
                ...
                ('supplier', models.ForeignKey(help_text='Select supplier', limit_choices_to={'is_supplier': True}, on_delete=django.db.models.deletion.CASCADE, related_name='supplied_parts', to='registry.company', verbose_name='Supplier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('manufacturer', models.ForeignKey(blank=True, db_constraint=False, help_text='Select manufacturer', limit_choices_to={'is_manufacturer': True}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.company', verbose_name='Manufacturer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, editable=False)),
                ('signature_url', models.URLField(help_text='The digital signature / address of this object on the block chain. Please refer to the README on registering components on the block chain.', validators=[common.validators.validate_url])),
                ('created_at', models.DateTimeField(blank=True, editable=False)),
                ('updated_at', models.DateTimeField(blank=True, editable=False)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('component', models.ForeignKey(blank=True, db_constraint=False, help_text='Select a component to link to this signature', limit_choices_to={'is_active': True}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.aircraftcomponent')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('belongs_to', models.ForeignKey(blank=True, db_constraint=False, help_text='Is this item installed in another item?', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.aircraftcomponent', verbose_name='Installed In')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ...
                ('supplier_part', models.ForeignKey(blank=True, db_constraint=False, help_text='Select a matching supplier part for this stock item', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='registry.supplierpart', verbose_name='Supplier Part')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='manufacturer',
            field=models.ForeignKey(help_text='Select manufacturer', limit_choices_to={'is_manufacturer': True}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='master_component_manufacturer', to='registry.company', verbose_name='Manufacturer'),
        ),
        migrations.CreateModel(
            name='AircraftDetail',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('component', models.OneToOneField(help_text='Select a component to link to this signature', limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.CASCADE, to='registry.aircraftcomponent')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='aircraftcomponent',
            name='supplier_part',
            field=models.ForeignKey(blank=True, help_text='Select a matching supplier part for this stock item', null=True, on_delete=django.db.models.deletion.SET_NULL, to='registry.supplierpart', verbose_name='Supplier Part'),
        ),
        migrations.AddField(

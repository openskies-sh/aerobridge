    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custody_status', models.IntegerField(choices=[(0, 'Created'), (1, 'Ordered'), (2, 'In Transit'), (3, 'Received')], default=0, help_text='Set the component status as it moves through the supply chain')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),

...
class Aircraft(models.Model):
    ...
    master_series = models.CharField(max_length = 280, blank= True, null=True, help_text="Specify the master series")    
    series = models.CharField(max_length = 280, blank= True, null=True, help_text="Enter aircraft production series")
    popular_name = models.CharField(max_length = 280, blank= True, null=True, help_text="Enter popular name for this aircraft")    
    manufacturer = models.ForeignKey(Manufacturer, models.CASCADE, help_text= "Associate a manufacturer to this aircraft")
    ...
    identification_photo = models.URLField(blank=True, null=True, help_text="A link to a photo of the URL")
    identification_photo_small = models.URLField(blank=True, null=True, help_text="A link to a photo of the URL")
